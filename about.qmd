...
df = read_excel("data/masterdata1.xlsx")

ggplot(dat, 
       aes(x= AverageCompositeScore, 
           y= FirstChoicepercent,
           color = SchoolType)) +
  geom_point(aes(size = TotalStudents) ,alpha=0.5)+
  scale_size(range = c(.1, 15), name="Number of Students")+
  scale_fill_viridis(discrete=TRUE, guide=FALSE, option="A") +
  theme_ipsum() +
  theme(legend.position="right") +
  ylab("Proportion Passing for First Choice School") +
  xlab("Average Composite Score")+
